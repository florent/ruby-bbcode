module RubyBBCode
  ...
  module Tags
    ...
    @@tags = {
      # Tags needed for Insided API support
      :h1 => {
        :html_open => '<h1>', :html_close => '</h1>',
        :description => 'Make h1 heading',
        :example => '[h1]This is a title[/h1]'},
      :h2 => {
        :html_open => '<h2>', :html_close => '</h2>',
        :description => 'Make h2 heading',
        :example => '[h2]This is a title[/h2]'},
      :h3 => {
        :html_open => '<h3>', :html_close => '</h3>',
        :description => 'Make h3 heading',
        :example => '[h3]This is a title[/h3]'},
      :"list=1" => {
      ...
      :quote => {
        :html_open => '<blockquote>%author%', :html_close => '</blockquote>',
